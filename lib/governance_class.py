...
class GovernanceClass(object):
    ...
    def list(self):
        ...
        # return a dict similar to tincoind "gobject list" output
    ...
    def tincoind_serialise(self):
        import tincoinlib
        return tincoinlib.SHIM_serialise_for_tincoind(self.serialise())
